...
// plugins
StatusSchema.plugin(mongooseExists);
StatusSchema.plugin(mongooseAutoset);
StatusSchema.plugin(mongooseRegexSearch);
StatusSchema.plugin(mongooseShow);
StatusSchema.plugin(mongooseEdit);
StatusSchema.plugin(mongooseReload);
StatusSchema.plugin(mongooseList);
StatusSchema.plugin(mongooseSoftDelete);
