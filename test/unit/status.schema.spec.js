...
describe('Status Schema', () => {
  it('should have jurisdiction field', () => {
    const jurisdiction = Status.path('jurisdiction');
  ...
  describe('name', () => {
    it('should be an embedded sub-document', () => {
      const name = Status.path('name');
      const en = Status.path('name.en');
      const sw = Status.path('name.sw');
  ...
  it('should have weight field', () => {
    const weight = Status.path('weight');
